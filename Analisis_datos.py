...
fname="atitlan25-08-18_2"

#Ingresar fecha inicial de datos con el formato YYYY_MM_DD_HHhMM
sdate = datetime.strptime("2018_04_28_04h00","%Y_%m_%d_%Hh%M")

#Ingresar fecha final de datos con el formato YYYY_MM_DD_HHhMM
edate = datetime.strptime("2018_04_28_07h00","%Y_%m_%d_%Hh%M")
